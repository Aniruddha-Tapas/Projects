...
class MainClassifier(ClassifierI):
...
voted_classifier = MainClassifier( classifier
                                  #NuSVC_classifier,
...
print("Classifier accuracy percent:", (nltk.classify.accuracy(voted_classifier, testing_set))*100)
